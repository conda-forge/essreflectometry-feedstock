...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/essreflectometry-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/essreflectometry-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add essreflectometry
# for installing globally
pixi global install essreflectometry
```
...
It is possible to list all of the versions of `essreflectometry` available on your platform:
...
```
pixi search essreflectometry --channel conda-forge
```
